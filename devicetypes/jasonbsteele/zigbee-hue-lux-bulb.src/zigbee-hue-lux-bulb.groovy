...
* http://community.smartthings.com/t/updated-ge-link-bulbs-finally-getting-on-status-after-manually-turning-on1
...
"st cmd 0x${device.deviceNetworkId} 255 6 1 {}"
...
"st cmd 0x${device.deviceNetworkId} 255 6 0 {}"
}
...
log.trace "refresh()"
[
"st rattr 0x${device.deviceNetworkId} 255 6 0", 
"delay 500",
"st rattr 0x${device.deviceNetworkId} 255 8 0"
]
}
...
if (value == 0) {
	sendEvent(name: "switch", value: "off")
	cmds << "st cmd 0x${device.deviceNetworkId} 255 6 0 {}"
}
...
cmds << "st cmd 0x${device.deviceNetworkId} 255 8 4 {${level} 0000}"
